...
class RepositoryFirebaseLogin{
  ...
  Future<String?> signUpFirebase(BuildContext context, String email, String password) async{
    return await ProviderLoginFirebase().createFirebaseUser(email, password, context);
  }
  ...
  Future<String?> forgotPasswordFirebase(BuildContext context, String email) async{
